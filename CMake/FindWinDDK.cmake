...
SET(WINDDK_WIN7_X86_LIBS "${WINDDK_HID_LIBRARY}"
	CACHE STRING "MS WinDDK Win7-x86 libraries" FORCE)
...
FIND_LIBRARY(WINDDK_HID_LIBRARY hid.lib
  	PATHS ${WINDDK_LIBRARY_SEARCH_DIRS})
SET(WINDDK_WIN7_X64_LIBS "${WINDDK_HID_LIBRARY}"
	CACHE STRING "MS WinDDK Win7-x64 libraries" FORCE)
UNSET(WINDDK_LIBRARY_SEARCH_DIRS CACHE)
UNSET(WINDDK_HID_LIBRARY CACHE)
UNSET(WINDDK_SETUPAPI_LIBRARY CACHE)
...
FIND_LIBRARY(WINDDK_HID_LIBRARY hid.lib
  	PATHS ${WINDDK_LIBRARY_SEARCH_DIRS})
SET(WINDDK_WINXP_X64_LIBS "${WINDDK_HID_LIBRARY}"
	CACHE STRING "MS WinDDK WinXP-x86 libraries" FORCE)
UNSET(WINDDK_LIBRARY_SEARCH_DIRS CACHE)
UNSET(WINDDK_HID_LIBRARY CACHE)
UNSET(WINDDK_SETUPAPI_LIBRARY CACHE)
