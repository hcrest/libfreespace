...
MouseMovement.Fields = [
    ...
    {name:"deltaX",     size:1, cType:'int16_t', Documentation:"Changes in pointer location in dimensionless units. Positive moves pointer right."},
    {name:"deltaY",     size:1, cType:'int16_t', Documentation:"Changes in pointer location in dimensionless units. Positive moves pointer down."},
    {name:"deltaWheel", size:1, cType:'int16_t', Documentation:"Reports scroll wheel motion in detents. Up is positive."}
]
...
ConsumerControl.Fields = [
    {name:"usageID",         size:1, cType:'int16_t', Documentation:"A 12-bit field that carries a consumer control usage code"},
...
BatteryLevel.Fields = [
    {name:"batteryStrength", size:1, cType:'int16_t', Documentation:"A percentage of the operating voltage range (0-100%)"},
...
BodyFrameMessage.Fields = [
    ...
    {name:"deltaX",         size:1, cType:'int16_t'},
    {name:"deltaY",         size:1, cType:'int16_t'},
    {name:"deltaWheel",     size:1, cType:'int16_t'},
...
Gen4SDAFormat.Fields = [
    ...
    {name:'xMov',        size:1, cType:'int16_t'},
    {name:'yMov',        size:1, cType:'int16_t'},
...
FactoryCalibrationReadData.Fields = [
    {name:"wordOffset",  size:1, cType:'int16_t', Documentation:"wordOffset indicates the number of words offset from the beginning of the factory calibration data the message begins."},
...
ProductIDResponse.Fields = [
    ...
    {name:'swVersionMinor', size:1, cType:'int16_t'},
    {name:'swVersionMajor', size:1, cType:'int16_t'},
    {name:'hwPlatformID',   size:1, cType:'int16_t'},
    {name:'hwRevision',     size:1, cType:'int16_t'},
...
SPIOperationResponse.Fields = [
    ...
    {name:'length', size:1, cType:'int16_t'},
]
...
UnknownCRSNotificationResponse.Fields = [
    {name:"unknownReportID",     size:1, cType:'int16_t', Documentation:"This is the HID report ID of the unknown message received by the handheld."},
    {name:"unknownSubMessageID", size:1, cType:'int16_t', Documentation:"This is the HID sub-message ID of the unknown message received by the handheld."},
    {name:RESERVED,     size:23}    
]
